  ...
  fetch(`/emails/${mailbox}`)
    ...
    .then((emails) => {
      ...
      emails.forEach((element) => {
        ...
        item.innerHTML = `<div class="card-body row" id="item-${element.id}">
                            <div class="bold col-2">${element.subject}</div>  <div class="senderr col-6">${sender_recipients}</div> <div class="timee col-4">${element.timestamp}</div>
                            <br>
                          </div>`;
