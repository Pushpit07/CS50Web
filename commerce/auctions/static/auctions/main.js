...
$(document).on('submit', '#addToWatchlist', function(e){
    ...
    if ($('#add_to_watchlist').hasClass('added')){
        $.ajax({
            type:'POST',
            ...
            success:function(){
                ...
                $('#heart').css("color", "#fe6f7d")
                $('.add_to_watchlist').css("background-color", 'white')
                $('#add_to_watchlist').removeClass('added')
            }
        })
    } else{
        $.ajax({
            ...
            success:function(){
                ...
                $('.add_to_watchlist').css("background-color", '#fe6f7d')
                $('#add_to_watchlist').addClass('added')
            }
        })
    }
});
